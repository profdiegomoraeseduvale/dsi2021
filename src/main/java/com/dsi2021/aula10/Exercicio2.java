...
public class Exercicio2 extends javax.swing.JFrame {
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        int fatorial = 1, contapar=0, contimpar=0;
        ...
        txtResultado.append(" = "+fatorial+"\n");
        txtResultado.append("Total de nº pares:"+contapar+"\n");
        txtResultado.append("Total de nº ímpares:"+contimpar+"\n");
        
        if(Math.pow(contapar, 3)>fatorial/6){
            txtResultado.append("É maior que o fatorial");
        }else{
            txtResultado.append("É menor que o fatorial");
        }
