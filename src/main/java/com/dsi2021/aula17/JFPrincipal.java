...
public class JFPrincipal extends javax.swing.JFrame {
     ...
     */
    private Consulta jinternal1;
    private Inserir jinternal2;
    ...
    private void mod2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mod2ActionPerformed
         if(jinternal2 == null){
            jinternal2 = new Inserir();
        }
        
        if(!jinternal2.isVisible()){
            deskPane.add(jinternal2);
            jinternal2.setVisible(true);
        }
